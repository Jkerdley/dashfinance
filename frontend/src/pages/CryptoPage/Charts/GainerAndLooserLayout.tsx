...
import { FormattedCryptoAsset } from '../../../hooks';

interface GainerAndLooserLayoutProps {
    cryptoAssetsInCurrency: FormattedCryptoAsset[];
	isLoading?: boolean;
}

export const GainerAndLooserLayout = memo((props: GainerAndLooserLayoutProps) => {
    const { cryptoAssetsInCurrency } = props;
