...
interface CryptoResultLayoutProps {
    cryptoAssetsInCurrency: any[];
    isMainPage?: boolean;
    isLoading?: boolean;
}

export const CryptoResultLayout = ({ cryptoAssetsInCurrency, isMainPage }: CryptoResultLayoutProps) => {
    return (
        <section
        ...
        >
            ...
            <CryptoResult cryptoAssetsInCurrency={cryptoAssetsInCurrency} />
        </section>
    );
};
