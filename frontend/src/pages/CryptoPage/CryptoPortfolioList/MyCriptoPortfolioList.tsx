...
import type { CryptoAssetItem } from './CryptoAssets';
...
interface MyCriptoPortfolioListProps {
    cryptoAssetsInCurrency: CryptoAssetItem[];
    cryptoCoins: any[];
    isLoading: boolean;
}

export const MyCriptoPortfolioList = (props: MyCriptoPortfolioListProps) => {
    const { cryptoAssetsInCurrency, cryptoCoins, isLoading } = props;
