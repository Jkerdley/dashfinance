	...
	return (
		<div className="flex flex-5 flex-col items-center justify-center">
			...
			<div className="flex items-center gap-2">
				<span
					className={`text-2xl md:text-3xl 2xl:text-5xl mt-2 font-medium transition-all duration-150 ease-in-out ${
				...
				<span
					className={`text-6xl 2xl:text-8xl font-bold transition-all duration-150 ease-in-out truncate ${
						parseInt(totalBalanceForDate.slice(1).trim(), 10) > 0
							? 'text-main-green'
							: 'text-main-red'
					}`}
