...
interface FinanceOperationHistoryProps {
    id: string;
    category: string;
...
const formatDate = (dateString: string): string => dateString.split('-').reverse().join('.');

export const FinanceOperationHistory = (props: FinanceOperationHistoryProps) => {
    const {
        id,
        category,
        operationType,
