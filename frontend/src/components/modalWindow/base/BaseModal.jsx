...
import { useModalClose, usePressKey } from '../../../hooks';
...
// 	const modalRef = useRef(null);
// 	const escButtonPressed = usePressKey('Escape');
// 	const { handleClose, isVisible, setIsVisible } = useModalClose(onClose);
...
// 			handleClose();
// 		}
// 	}, [escButtonPressed, isOpen, handleClose]);
...
// 			<div
// 				className={`
//                     absolute w-full h-full bg-gray-950/85 transition-opacity duration-400 ease-in-out
//                     ${isVisible ? 'opacity-100' : 'opacity-0'}
//                 `}
// 				onClick={handleClose}
// 			/>
